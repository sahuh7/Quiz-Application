...
public class PaperSelectionFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Fill Paper Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jcSubject.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Choose Subject", "C", "C++", "Java" }));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(6, 6, 6)
                        .addComponent(btnTakeTest, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jcSubjectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcSubjectActionPerformed
        if(!validateInput()){
            JOptionPane.showMessageDialog(null, "Please select subject","Select Subject",JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        try{
            ArrayList<String> examList = ExamDAO.getExamIdBySubject(subjectName);
            if(examList.isEmpty()){
                JOptionPane.showMessageDialog(null, "No Exam for selected Subject","No Paper Fount",JOptionPane.INFORMATION_MESSAGE);
                return;
            }
            else{
    ...
    private void btnTakeTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTakeTestActionPerformed
        ...
        if(jcExamId.getItemCount()==0){
            JOptionPane.showMessageDialog(null, "Please select exam id","Error",JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        ...
        if(ans==JOptionPane.YES_OPTION){
            try{
                ...
                Exam takeExam = new Exam(examId, subject, totalQuest);
                new TakeTestFrame(takeExam).setVisible(true);
                this.dispose();
            } catch(SQLException ex){
                JOptionPane.showMessageDialog(null, "SQL Error : "+ex, "Error", JOptionPane.ERROR_MESSAGE);
            }
